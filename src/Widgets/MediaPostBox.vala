...
public class PhotoStream.Widgets.MediaPostBox : Gtk.Box
{
	public Gtk.Box box;
	...
	public void loadPost(MediaInfo post)
	{
		this.post = post;
        ...
        dateLabel.set_text(post.creationTime.format("%e.%m.%Y %H:%M"));
        likesLabel.set_text( post.likesCount.to_string() + " likes.");
